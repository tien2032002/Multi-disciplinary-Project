            ...
            <div class="col-md-auto background-primary-color vh-100 nopadding">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item d-flex align-items-center">
                        ...
                        <a class="nav-link active text-white nopadding" href="user_webpage.html">Thông tin người dùng</a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
                    ...
                    <li class="nav-item d-flex align-items-center">
                        ...
                        <a class="nav-link active text-white nopadding" href="#">Đăng xuất</a>
                    </li>
