...
<body onload="getMainContent('index.php?controller=manager&action=station_list')">
            ...
            <div class="col-md-auto background-primary-color vh-100 nopadding">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item d-flex align-items-center">
                        ...
                        <a class="nav-link active text-white nopadding" onclick="getMainContent('index.php?controller=manager&action=user_webpage')">Thông tin người dùng</a>
                    </li>
                    <li class="nav-item d-flex align-items-center selected">
                        ...
                        <a class="nav-link active text-white nopadding " onclick="getMainContent('index.php?controller=manager&action=station_list')">Danh sách trạm</a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
                    ...
                    <li class="nav-item d-flex align-items-center">
                        ...
                        <a class="nav-link active text-white nopadding" onclick="getMainContent('index.php?controller=manager&action=environment'); clearAllInterval(); humidInterval = setInterval(updateSensorData, 1000, 'temp')">Tình trạng môi trường</a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
    ...
    <script>clearAllInterval()</script>
</body>
</html>